...
HD_PWD='D:/ProgramasDoctorado/propuestadesdecero/propuestadesdecero.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log top_hog_axi.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source top_hog_axi.tcl -notrace
